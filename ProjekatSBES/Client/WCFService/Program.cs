...
namespace WCFService
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            serviceHost.Credentials.ServiceCertificate.Certificate = Sertifikati.GetCertificateFromStorage(StoreName.My, StoreLocation.LocalMachine, serviceCertificateCN);
            ...
            Service_Client.ServiceClientLoggerKomunikacija.InitializeService(bindingLogger, endpointAddress);
